...
│   ├── spider/                 # HTTP-клиент - Основной проект Visual Studio (с Main.cpp и config.ini)
│   └── search_server/          # HTTP-сервер - Основной проект Visual Studio (с Main.cpp и config.ini)
...
## Сборка проекта search_server

1. **Откройте решение в Visual Studio**  
   Запустите Visual Studio 2022 и откройте файл `search_server.sln`.

2. **Сделайте настройти аналогично проекту `spider` (порядок действий смотри выше)**  
